...
| **V1.5** | • **Auto-Advance Anti-Stall:** Forces a commutation step on timeout to keep momentum alive during false positives[cite: 2].<br>• **Strike System:** Implemented a 4-strike error counter before declaring a true physical prop jam. |
